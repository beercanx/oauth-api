...
class AuthorisationWithConfidentialSimulation : Simulation() {

    private val theScenario = scenario("Authorisation Code Grant with Confidential Client")
        ...
        .exec(generateState())
        .exec(confidentialAuthorisationWithPage(Confidential))
        .exitHereIfFailed()
        .exec(authenticate)
        .exitHereIfFailed()
        .exec(confidentialAuthorisationWithCode(Confidential))
        .exitHereIfFailed()
        .exec(authorisationCodeGrant(Confidential))
        .exitHereIfFailed()
