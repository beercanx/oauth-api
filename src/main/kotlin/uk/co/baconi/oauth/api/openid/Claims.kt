...
enum class Claims {
     ...
     */
    @SerialName("given_name") GivenName,
     ...
     */
    @SerialName("family_name") FamilyName,
     ...
     * not used.
     */
    @SerialName("middle_name") MiddleName,
     ...
     */
    @SerialName("preferred_username") PreferredUserName,

    /**
     * URL of the End-User's profile page. The contents of this Web page SHOULD be about the End-User.
     */
    @SerialName("profile") ProfileUrl,
     ...
     */
    @SerialName("birthdate") Birthdate,
     ...
     */
    @SerialName("phone_number") PhoneNumber,
     ...
     */
    @SerialName("phone_number_verified") PhoneNumberVerified,
     ...
     */
    @SerialName("updated_at") UpdatedAt,
}